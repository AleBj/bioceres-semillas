            ...
            <div class="relative px-20 s:px-240">
                ...
                <div class="relative flex flex-col s:flex-row items-start pb-100 s:pb-145 js-s-fade">
                    ...
                    <div class="relative s:left-[18rem] w-full s:w-[57rem]">
                        ...
                        <figure class="hidden s:block relative w-full s:top-[-10rem] s:scale-[1.3] mt-20 s:mt-0">
                            <svg class="relative z-3 w-full " xmlns="http://www.w3.org/2000/svg" viewBox="0 0 272 325.001">
