                    ...
                    <div class="relative pt-150 pl-20 s:pl-240 pr-20 s:pr-0 z-3">
                        ...
                        <div class="relative block s:hidden js-t-fades">
                            <figure class="relative w-full h-[35rem]">
                                <img class="w-full h-full object-contain" src="/iso-semillas-productos.svg" alt="Producto Detalle">
        ...
        <div class="hidden s:block absolute top-0 s:right-[20rem] w-[43rem] h-full z-10">
            <div class="s:sticky s:top-0 s:h-screen flex items-center justify-center js-t-fades">
                <figure class="relative w-full h-[56rem]">
                    <img class="w-full h-full object-contain opacity-30" src="/iso-semillas-productos.svg" alt="Producto Detalle">
                    <img class="absolute h-[80%] left-[50%] top-[50%]" style="transform: translate(-50%,-50%);" :src="product.data.imagen.url" :alt="product.data.imagen.alt">
                </figure>
            </div>
        </div>
